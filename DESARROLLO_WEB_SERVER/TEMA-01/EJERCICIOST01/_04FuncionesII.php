    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td colspan="3">
                        <p><b>Cálculo del precio final después de aplicar un descuento</b></p>
                        <p>Mostrar el mensaje: El precio final es 478.55</p>
                    </td>
                </tr>
                <tr>
                    <td>
...
$descuento = 15;
            ...
            <tbody>
                <tr>
                    <td colspan = "3"><p><b>Determina si un año es bisiesto</b></p>
                        <p>Mostrar el mensaje: El año 2024 es bisiesto</p>
                    </td>
                </tr>
                <tr>
                    <td>$anio = 2024;</td>
            ...
            <tbody>
                <tr>
                    <td colspan = "3">
                        <p><b>Conversión de Celsius a Farenheit</b></p>
                        <p>Mostrar el mensaje: 25 grados Celsius corresponden a 77 grados Farenheit</p>
                    </td></tr>
            <td>$celsius = 25;</td>
    ...
    <tbody>
        <tr>
            <td colspan = "3">
                <p><b>Obtener las iniciales de un nombre y apellidos</b></p>
                <p>Mostrar el mensaje: Las iniciales de Juan Perez Martinez son J P M</p>
            </td>
        </tr>
        <tr>
    ...
    <tbody>
        <tr>
            <td colspan = "3">
                <p><b>Comprueba si una fecha es correcta entre el año 1000 y 3000</b></p>
                <p>Mostrar el mensaje: La fecha 28/2/1399 es correcta</p>
            </td>
        <tr>
        <tr>
            <td>
