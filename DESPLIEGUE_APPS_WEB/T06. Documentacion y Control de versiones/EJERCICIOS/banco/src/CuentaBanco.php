...
class CuentaBanco
{
     ...
     * @return saldo El saldo de la cuenta de banco o lanza una excepción si no se ha podido ha
     * @throws Exception Excepción por intentar retirar dinero de una cuenta sin suficientes fo
     */
